...
class NewsLetterRequest(BaseModel):
    instructions_for_scrapping:List[QueryModel]
...
@newsletter_router.post("/create_newsletter", tags=["summarize"])
async def newsletter_route(request: Request, body: NewsLetterRequest) :
    try:
        print("newsletter_route")
        #scrap to get urls
        instructions_for_scrapping = body.instructions_for_scrapping
        instructions_for_ranking= body.instructions_for_ranking
        model = body.model
        print(instructions_for_scrapping)
        print(instructions_for_ranking)
        print("STARTING")
        list_hrefs = await list_all_article_urls_from_json_instructions(instructions_for_scrapping)
